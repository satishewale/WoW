...
!function () {
    ...
    var a, b, c, d = "/public/invoice/generator/", e = "?utm_source=generator&utm_medium=template&utm_campaign=invoicebus_templates", f = "https://invoicebus.com/saveinvoice/", g = ".min", h = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", i = d + "jquery.min.js", j = d + "bootstrap.min.js", k = function () {
    ...
    }, l = 100, m = 0, n = 5e3, o = function (a) {
        var b = document.createElement("script");
        b.async = !0, b.type = "text/javascript", b.src = a, document.body.appendChild(b)
    }, p = function (a) {
        return m > n ? k() : (window.jQuery ? (o(j), q(a)) : setTimeout(function () {
            p(a)
        }, l), void(m += l))
    }, q = function (a) {
        return m > n ? k() : (jQuery.fn.tooltip ? a(jQuery) : setTimeout(function () {
            q(a)
        }, l), void(m += l))
    }, r = function () {
        $(function () {
            v(), ib_loadBootstrapDatepicker(), ib_loadBootstrapTypeahead(), ob(), D(), gb(), F(), ib(), pb(), R(), P(), Q(), A(), x(), s()
        })
    }, s = function () {
        var a = setInterval(function () {
            for (var b = 0; b < document.styleSheets.length; b++)if (-1 != document.styleSheets[b].href.indexOf("generator" + g + ".css")) {
                $("html").removeAttr("style"), $("body").removeAttr("style"), clearInterval(a), window.status = "finished";
                break
            }
        }, 10)
    }, t = ["a", "b", "body", "br", "div", "em", "footer", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hr", "html", "i", "img", "label", "li", "link", "meta", "ol", "p", "pre", "section", "span", "strong", "style", "sub", "sup", "table", "tbody", "td", "tfoot", "th", "thead", "title", "tr", "ul"], u = ["cellpadding", "cellspacing", "charset", "class", "colspan", "content", "data-hide-on-quote", "data-iterate", "data-logo", "dir", "height", "href", "http-equiv", "id", "lang", "name", "rel", "rowspan", "src", "style", "title", "type", "width"], v = function () {
        $(document).find(":not(" + t.join(",") + ")").remove(), $("*").each(function () {
            for (var a = 0; a < this.attributes.length; a++)-1 == u.indexOf(this.attributes[a].name) && this.removeAttribute(this.attributes[a].name)
        ...
        y ? (a.addClass("ib_editable_outline ib_stop_animate"), $(".ib_highlight_editable").css("font-weight", "bold")) : (a.removeClass("ib_editable_outline"), $(".ib_highlight_editable").css("font-weight", "normal"))
    }, A = function () {
        $("head").prepend('<link rel="stylesheet" href="' + d + "generator" + g + '.css" media="all" />'), $(document.body).before($('<ib-span class="ib_invoice_commands_wrap"><ib-span class="ib_invoice_commands"><ib-span id="ib-print-btn" class="ib_default_button"><i class="fa fa-print"></i> Print</ib-span><ib-span class="ib_default_button ib_success_button"><i class="fa fa-save"></i> Save</ib-span><ib-span class="ib_save_info" data-tooltip="tooltip" data-placement="right" title="You\'ll need Invoicebus account to save this invoice"><i class="fa fa-question-circle"></i></ib-span><ib-span class="ib_gray_link ib_how_to_link ib_pull_right" data-toggle="modal" data-target="#ib_howToModal"></ib-span><ib-span class="ib_top_separator ib_pull_right">●</ib-span><ib-span class="ib_gray_link ib_highlight_editable ib_pull_right"></ib-span></ib-span></ib-span>')).after($("<ib-span class=\"ib_invoicebus_love\">Crafted with &#x2764; by<br><ib-span ></ib-span></ib-span>")), $("#ib-print-btn").click(function () {
            y = !1, z(), window.print()
        ...
        }), $(document.body).after($("<ib-span class=\"ib_invoicebus_fineprint\"> <ib-span></ib-span></ib-span>")), a.invoicebus_fineprint || $(".ib_invoicebus_fineprint").css("visibility", "hidden"), $(".ib_success_button").click(sb), $('[data-iterate="item"]:last').after($('<ib-span class="ib_bottom_row_commands"><ib-span class="ib_blue_link ib_add_new_row_link">Add new row</ib-span><ib-span class="ib_blue_link ib_show_hide_columns_link">Configure Columns</ib-span></ib-span>')), $(".ib_add_new_row_link").click(function (a) {
            eb(this, a)
            ...
            var a = $(this).val();
            "item_row_number" == a ? $('[data-ibcl-id="' + a + '_label"], [data-ibcl-id="' + a + '"]').toggleClass("ib_hide_column", !$(this).is(":checked")) : ($('[data-ibcl-id="' + a + '_label"], [data-ibcl-id="' + a + '"]').toggle($(this).is(":checked")), $('[data-ibcl-id="' + a + '_label"]').hasClass("ibcl_ie_contenteditable") && $('[data-ibcl-id="' + a + '_label"]').parent().toggle($(this).is(":checked")), $('[data-ibcl-id="' + a + '"]').hasClass("ibcl_ie_contenteditable") && $('[data-ibcl-id="' + a + '"]').parent().toggle($(this).is(":checked")), Z())
        });
        ...
        if (!(C > n)) {
            if ("undefined" != typeof ib_invoice_data) {
                for (var b in ib_invoice_data)"undefined" != typeof a[b].default_text ? a[b].default_text = ib_invoice_data[b] : a[b] = ib_invoice_data[b];
                mb = ib_invoice_data.currency_position, lb = $(kb).map(function (b, c) {
        ...
        for (var e = b.substring(1, b.length - 1), f = "TABLE,COL,COLGROUP,TBODY,TD,TFOOT,TH,THEAD,TR".split(","), g = $('*:contains("' + b + '")'), h = 0; h < g.length; h++)if (0 === $(g[h]).children().length && 3 == $(g[h]).prop("firstChild").nodeType) {
            var i = $(g[h]);
            if (w() && f.indexOf(i.prop("tagName")) > -1 && !c) {
    ...
    }, I = 820, J = 820, K = 1, L = 0, M = 0, N = 820, O = 820, P = function () {
        $('[data-logo="{company_logo}"]').attr("data-logo", "company_logo").attr("src", h)
    }, Q = function () {
        var b = $('[data-logo="company_logo"]').attr("src", h);
        $(document).bind("drop dragover", function (a) {
            a.stopPropagation(), a.preventDefault(), a.originalEvent.dataTransfer.dropEffect = "none"
        });
        var c = '<ib-div id="ib_base64Modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="base64Modal" aria-hidden="true"><ib-div class="modal-dialog"><ib-div class="modal-content"><ib-div class="modal-header"><ib-span type="button" class="close" data-dismiss="modal"><ib-span aria-hidden="true">&times;</ib-span></ib-span><ib-div class="modal-title" id="howToModal">Base64 Data URI</ib-div></ib-div><ib-div class="modal-body"><textarea class="ib_logo_base64" readonly onclick="this.focus();this.select();" onfocus="this.select();"></textarea></ib-div><ib-div class="modal-footer"><ib-span class="ib_default_button" data-dismiss="modal">Close</ib-span></ib-div></ib-div></ib-div></ib-div>';
        $(document.body).after($(c)), $("#ib_base64Modal").on("show.bs.modal shown.bs.modal", function () {
            try {
                $(".ib_logo_base64").select()
            } catch (a) {
                $(".ib_logo_base64").focus()
            }
        }), b.after($('<ib-div class="ib_remove_logo_overlay" data-tooltip="tooltip" data-placement="top" data-toggle="modal" data-target="#ib_base64Modal" title="Click to see the base64 data URI"><ib-span class="ib_remove_logo" title="Remove logo"><i class="fa fa-times-circle"></i></ib-span></ib-div>').hover(function () {
        }, function () {
            $(".ib_remove_logo_overlay").hide()
        })), b.hover(function () {
            if ("" !== b.attr("src")) {
                var a = $('[data-logo="company_logo"]').offset();
                $(".ib_remove_logo_overlay").show().offset(a).width(L).height(M)
            }
        }, function () {
        }), setTimeout(function () {
            L = $('[data-logo="company_logo"]').width(), M = $('[data-logo="company_logo"]').height(), K = L / M, L > M ? J *= 1 / K : I *= K, b.hide().before($('<ib-span class="ib_drop_zone" data-tooltip="tooltip" data-placement="top" title="Drop image or click to upload your logo (max 2MB).<br>For better print resolution use larger image,<br>as it\'s automatically scaled down."><ib-span>Drop your logo here<br /><ib-span>(' + L + " x " + M + 'px)</ib-span><input type="file" accept="image/*" /></ib-span></ib-span>').width(L).height(M)), $(".ib_drop_zone").bind("dragenter", g).bind("dragleave", i).bind("dragover", f).bind("drop", d), $("input:file").change(function (a) {
                a.originalEvent.dataTransfer = {files: $(this).prop("files")}, d(a)
            }), setTimeout(function () {
        ...
        var d = function (a) {
            ...
            if (d) {
                ...
                f.onload = function (a) {
                    ...
                    N = I, O = J, N >= a && a >= c && (O = 1 * a / K, N = a), O >= c && c >= a && (N = c * K, O = c), L >= a && a >= c && (O = 1 * L / K, N = L), M >= c && c >= a && (N = M * K, O = M), a >= N && (c *= N / a, a = N), c >= O && (a *= O / c, c = O), 1 > a && (a = 1), 1 > c && (c = 1);
                    var d = document.createElement("canvas");
                    d.width = N, d.height = O;
                    var f = (N - a) / 2, g = d.getContext("2d");
            ...
            a.preventDefault(), a.stopPropagation(), b.attr("src", h).hide(), $(".ib_drop_zone").show(), $(".ib_remove_logo_overlay").hide(), $("input:file").val("")
        }, f = function (a) {
        ...
        $(".ib_remove_logo").click(e)
    }, R = function () {
        b = $('[data-iterate="item"]'), c = $('[data-iterate="tax"]').hide().clone();
        var d = 1, e = a.default_number_rows;
        ...
        for (var c = 0; c < a.length; c++)if (tax_row = $(a[c]).find('[data-ib-value="' + b + '"]'), tax_row.length)return c;
        return -1
    }, U = function (a) {
        return $('[data-iterate="tax"]:visible').find('[data-ib-value="' + a + '"]').closest('[data-iterate="tax"]').find('[data-ibcl-id="tax_name"]').text().replace(/:/gi, "")
    };
    ...
    var V, W, X, Y, Z = function () {
        for (var b, d, e, f = $('[data-iterate="item"]'), g = 0, h = 0, i = 0, j = [], k = 0; k < f.length; k++) {
            ...
            q.text(0 !== r ? r.toFixed(2) : "")
        }
        var v, w, x = [];
        for (e = 0; e < j.length; e++)w = Object.keys(j[e])[0], v = $('[data-iterate="tax"]:visible').find('[data-ib-value="' + w + '"]').closest('[data-iterate="tax"]'), v.length && x.push($(v).clone());
        for ($('[data-iterate="tax"]:visible').remove(), e = 0; e < j.length; e++) {
            w = Object.keys(j[e])[0];
            var y = T(x, w);
            if (y > -1)$('[data-iterate="tax"]:hidden').before(x[y]); else {
                v = c.clone().show();
                var A = v.find('[data-ibcl-id="tax_name"]'), B = A.text().trim(), C = B.lastIndexOf(":");
                (-1 == C || C != B.length - 1) && (C = B.length), A.text(B.substring(0, C) + " " + (e + 1) + B.substring(C, B.length)), v.find('[data-ibcl-id="tax_value"]').attr("data-ib-value", Object.keys(j[e])[0]), $('[data-iterate="tax"]:hidden').before(v)
            }
        }
        for (e = 0; e < j.length; e++)w = Object.keys(j[e])[0], v = "left" == mb ? lb + j[e][w].toFixed(2) : j[e][w].toFixed(2) + lb, $('[data-iterate="tax"]').find('[data-ib-value="' + w + '"]').html(v);
        var D = g + h;
        isNaN(b) && (b = 0, $('[data-ibcl-id="amount_paid"]').text(b.toFixed(2))), isNaN(d) && (d = 0), d = D - b, g = "left" == mb ? lb + g.toFixed(2) : g.toFixed(2) + lb, D = "left" == mb ? lb + D.toFixed(2) : D.toFixed(2) + lb, d = "left" == mb ? lb + d.toFixed(2) : d.toFixed(2) + lb, $('[data-ibcl-id="amount_subtotal"]').text(g), $('[data-ibcl-id="amount_total"]').text(D), $('[data-ibcl-id="amount_due"]').text(d), z()
    }, _ = function () {
        ...
        if (a.load_items) {
            ...
            for (var c = 0; c < a.items.length; c++)$(b[c]).find('[data-ibcl-id="item_description"]').text(a.items[c].item_description), $(b[c]).find('[data-ibcl-id="item_quantity"]').text(a.items[c].item_quantity), $(b[c]).find('[data-ibcl-id="item_price"]').text(a.items[c].item_price), $(b[c]).find('[data-ibcl-id="item_discount"]').text(a.items[c].item_discount), $(b[c]).find('[data-ibcl-id="item_tax"]').text(a.items[c].item_tax)
        }
    }, cb = function () {
        ...
        }), new ib_TableDnD(ab, qb).init(), db()
    }, db = function () {
        function a(a) {
            var b = this;
            if (a.ctrlKey)return !0;
            if (a.keyCode >= 35 && a.keyCode <= 40 || a.keyCode >= 48 && a.keyCode <= 57 && !a.shiftKey || a.keyCode >= 96 && a.keyCode <= 105 || 8 == a.keyCode || 9 == a.keyCode || 46 == a.keyCode || 190 == a.keyCode || 110 == a.keyCode || 116 == a.keyCode)switch ($(this).data("ibcl-id")) {
                case"item_tax":
                case"item_discount":
                    setTimeout(function () {
                        if (isNaN(b.textContent.getNumber()) && (b.textContent = ""), !isNaN(b.textContent.getNumber())) {
                            var c = window.getSelection().extentOffset;
                            if (b.textContent = -1 == b.textContent.indexOf("%") ? b.textContent + "%" : (-1 != b.textContent.indexOf("-") ? "-" : "") + b.textContent.getNumber() + "%", c == b.textContent.length ? c-- : 0 === c && -1 != b.textContent.indexOf("-") && (c = 1), 9 != a.keyCode)try {
                ...
                case"amount_paid":
                    setTimeout(function () {
                        if (isNaN(b.textContent.getNumber()) && (b.textContent = ""), !isNaN(b.textContent.getNumber())) {
                            var c = window.getSelection().extentOffset;
                            if (-1 != b.textContent.indexOf("-") && (b.textContent = "-" + b.textContent.getNumber().toFixed(2)), 0 === c && -1 != b.textContent.indexOf("-") && (c = 1), 9 != a.keyCode)try {
                                window.getSelection().collapse(b.firstChild, c)
                            } catch (d) {
                            }
                        }
            ...
            -1 == $(this).text().indexOf(".") || 190 != a.keyCode && 110 != a.keyCode || a.preventDefault(), "net_term" == $(this).data("ibcl-id") && (190 == a.keyCode || 110 == a.keyCode || $(this).text().length >= 3 && a.keyCode >= 48 && a.keyCode <= 57 && window.getSelection().isCollapsed) && a.preventDefault(), setTimeout(Z, 0), "net_term" == $(this).data("ibcl-id") && setTimeout(jb, 0)
        }
        ...
        c.stopPropagation(), c.preventDefault(), $(a).hasClass("ib_add_new_row_link") ? $(a).closest(".ib_bottom_row_commands").before($(b).clone()) : $(a).closest('[data-iterate="item"]').before($(b).clone()), ab(), cb(), $(".ib_show_hide_columns > ib-span > input:checkbox").each(function (a) {
            $(".ib_show_hide_columns > ib-span > input:checkbox:nth(" + a + ")").change()
        }), z()
    }, fb = function (a, b) {
        b.stopPropagation(), b.preventDefault(), $(a).closest('[data-iterate="item"]').remove(), ab()
    }, gb = function () {
        V = new Date, W = new Date((new Date).setDate((new Date).getDate() + a["{net_term}"].default_text)), X = hb(V, a.date_format), Y = hb(W, a.date_format), a["{issue_date}"].default_text = X, a["{due_date}"].default_text = Y
    }, hb = function (a, b) {
        ...
        var b = $('<ib-div class="ib_date_format"><ib-div><input type="radio" id="ib_date_format_radio1" name="ib_date_format_choice" value="dd/mm/yyyy"><label for="ib_date_format_radio1">dd/mm/yyyy</label></ib-div><ib-div><input type="radio" id="ib_date_format_radio2" name="ib_date_format_choice" value="dd-mm-yyyy"><label for="ib_date_format_radio2">dd-mm-yyyy</label></ib-div><ib-div><input type="radio" id="ib_date_format_radio3" name="ib_date_format_choice" value="mm/dd/yyyy"><label for="ib_date_format_radio3">mm/dd/yyyy</label></ib-div><ib-div><input type="radio" id="ib_date_format_radio4" name="ib_date_format_choice" value="mm-dd-yyyy"><label for="ib_date_format_radio4">mm-dd-yyyy</label></ib-div></ib-div>').hover(function () {
            $(this).show()
        }, function () {
            $(this).hide()
        });
        $(document.body).after(b), $('[data-ibcl-id="issue_date"]').datepicker({format: a.date_format}).data("datepicker"), $('[data-ibcl-id="due_date"]').datepicker({
            format: a.date_format,
            onRender: function (a) {
                return V.setHours(0, 0, 0, 0), a.valueOf() < V.valueOf() ? "disabled" : ""
            }
        }).data("datepicker"), $('[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]').on("changeDate", function (b) {
            if ("days" == b.viewMode) {
                $(this).text($(this).data("date"));
                var c = a["{net_term}"].default_text || 0;
        ...
        $(document.body).after(a), $('[data-ibcl-id="currency"]').typeahead({
            source: function (a, b) {
                ib_currencies_combo = [], $.each(kb, function (a, b) {
                ...
                return lb = $(a).data("symbol"), Z(), $(a).data("code")
            }, matcher: function (a) {
            ...
            lb = "", a.text(b), $.each(kb, function (c, d) {
                return d.code.toUpperCase() == b ? (a.text(d.code), lb = d.symbol, void Z()) : void 0
            })
        }).hover(function () {
            ...
            a.hide()
        }), $('#ib_currency_left[value="' + mb + '"], #ib_currency_right[value="' + mb + '"]').attr("checked", "checked"), $("#ib_currency_left, #ib_currency_right").change(function () {
            mb = $(this).val(), Z()
        })
    }, qb = function () {
        var b = {
        ...
        return b.hash = $('meta[name="template-hash"]').attr("content") || b.hash, b.type = $('meta[name="document-type"]').attr("content") || b.type, $('[data-logo="company_logo"]').is(":visible") && (b.company_logo = $('[data-logo="company_logo"]').attr("src") || b.company_logo), $("[data-ibcl-id]").each(function (a, c) {
            var d = $(c);
            b[d.data("ibcl-id")] = $("<div />").html(d.html().replace(/<br\s*(\/|\s*)>/gi, "\n")).text() || b[d.data("ibcl-id")]
        }), b.net_term || (b.net_term = Math.floor(Math.abs((W.getTime() - V.getTime()) / 864e5))), $(".ib_show_hide_columns > ib-span > input:checkbox").each(function (a, c) {
            ...
            var d = {};
            $(c).children().each(function (a, b) {
                var c = $(b);
                d[c.data("ibcl-id")] = $("<div />").html(c.html().replace(/<br\s*(\/|\s*)>/gi, "\n")).text()
            }), d.item_quantity = d.item_quantity.getNumber(), d.item_price = d.item_price.getNumber(), d.item_tax_percentage = d.item_tax.getNumber(), d.item_tax = U(d.item_tax.getNumber()), d.item_discount = d.item_discount.getNumber(), d.item_line_total = d.item_line_total.getNumber(), b.items.push(d)
        }), delete b.tax_name, delete b.tax_value, $('[data-iterate="tax"]:visible').each(function (a, c) {
            var d = {};
            $(c).children().each(function (a, b) {
                var c = $(b);
                d[c.data("ibcl-id")] = $("<div />").html(c.html().replace(/<br\s*(\/|\s*)>/gi, "\n")).text(), c.attr("data-ib-value") && (d.tax_percentage = c.attr("data-ib-value").getNumber())
            }), d.tax_value = d.tax_value.getNumber(), b.taxes.push(d)
        }), b.amount_subtotal = b.amount_subtotal.getNumber(), b.amount_total = b.amount_total.getNumber(), b.amount_paid = b.amount_paid.getNumber(), b.amount_due = b.amount_due.getNumber(), b.date_format = a.date_format, b.currency_code = b.currency, b.currency_symbol = lb, delete b.currency, b.currency_position = $('.ib_currency_position input[type="radio"]:checked').val(), b
    }, rb = !1, sb = function () {
        if (!rb) {
            rb = !0, $(this).addClass("ib_disabled_button").attr("disabled", "disabled").find("i.fa").removeClass("fa-save").addClass("fa-spinner fa-spin");
            var a = $("<div />").text(JSON.stringify(qb())).html().replace(/"/gi, "&quot;");
            f += e + "&utm_term=" + encodeURIComponent(document.title), $('<form id="ib_save_tamplate_form" style="display:none !important;" action="' + f + '" method="POST" />').append($('<input type="hidden" name="invoice_data" value="' + a + '" />')).appendTo($(document.body)).submit()
        }
    }, tb = function (a, b) {
    ...
    o(i);
    var ub = B();
    tb("data", ub) && o(tb("data", ub)), p(function () {
        r()
    })
}();
